package xyz.pkdev.ecomapp.web.service;
...
import xyz.pkdev.ecomapp.repository.CategoryRepository;
import xyz.pkdev.ecomapp.repository.CouponRepository;
import xyz.pkdev.ecomapp.repository.ProductRepositry;
import xyz.pkdev.ecomapp.entity.Carousel;
...
public class ProductService {
	...
	public Product getProductWithBigestDiscount() {
		...
		Integer maxDiscount = couponRepository.findMaxDiscount();
		...
		for (Product p : products) {
			...
			if (p.getDiscount() != null &&
					p.getDiscount().getDiscount() == maxDiscount) {
